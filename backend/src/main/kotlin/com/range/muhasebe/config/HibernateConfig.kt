package com.range.muhasebe.config

import com.range.muhasebe.config.tenant.CurrentTenantIdentifierResolverImpl
import com.range.muhasebe.config.tenant.SchemaMultiTenantConnectionProvider
...
class HibernateConfig(
    ...
    fun entityManagerFactory(): LocalContainerEntityManagerFactoryBean {
        ...
        properties["hibernate.hbm2ddl.auto"] = "update" // veya validate
